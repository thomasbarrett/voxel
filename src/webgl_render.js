...
function world_render(gl, worldBuffer, texture, programInfo, aspect_ratio) {

    let projection_matrix_buffer = instance.exports.world_get_projection_matrix(worldBuffer, aspect_ratio);
    let projectionMatrix = new Float32Array(instance.exports.memory.buffer, projection_matrix_buffer, 16);
    ...
    for (let i = 0; i < instance.exports.world_get_chunk_count(worldBuffer); i++) {
        let chunk = instance.exports.world_get_chunk_by_index(worldBuffer, i);
